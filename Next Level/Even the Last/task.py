...
the final element of the array together. Don't forget that the first element has an index of 0.
...
Example:
even_times_last([0, 1, 2, 3, 4, 5]) == 30
even_times_last([1, 3, 5]) == 30
even_times_last([6]) == 36
even_times_last([]) == 0
